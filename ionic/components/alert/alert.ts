import {Component, ElementRef, Renderer, HostListener, ChangeDetectionStrategy, ViewEncapsulation} from '@angular/core';
import {NgClass, NgSwitch, NgIf, NgFor} from '@angular/common';
